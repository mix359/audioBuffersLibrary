...
#ifndef ABL_OFFSETTEDREADCIRCULARAUDIOBUFFERCHANNELVIEW_H
#define ABL_OFFSETTEDREADCIRCULARAUDIOBUFFERCHANNELVIEW_H
...
class OffsettedReadCircularAudioBufferChannelView {
public:
...
#endif //ABL_OFFSETTEDREADCIRCULARAUDIOBUFFERCHANNELVIEW_H
